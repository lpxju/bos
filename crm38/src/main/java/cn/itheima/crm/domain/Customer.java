...
public class Customer {
	@Id //@GeneratedValue主键生成策略 默认会根据数据库选则生成策略 strategy指定生成策略  generator:主键使用哪个序列
	//sequenceName:数据库中序列名称 initialValue：初始值  allocationSize：每次增加50
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="mySeq")
	@SequenceGenerator(name = "mySeq", sequenceName = "customer_seq", initialValue = 1000, allocationSize = 50)
	@Column(name = "C_ID")
